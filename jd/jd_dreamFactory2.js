...
[task_local]
#京喜工厂
0 17 * * * jd_dreamFactory.js, tag=京喜工厂, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "0 17 * * *" script-path=jd_dreamFactory.js,tag=京喜工厂
